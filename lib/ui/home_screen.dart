                ...
                return Container(
                  ...
                  Expanded(child: Column(
                    ...
                    Text('${userModel.name}',style :GoogleFonts.robotoMono(fontSize: 22 , color: Colors.white, fontWeight: FontWeight.bold),),
                      Text('${userModel.address}',style :GoogleFonts.robotoMono(fontSize: 15 , color: Colors.white, fontWeight: FontWeight.w800),)
                  ],
                ...
                Expanded(
                    child: GestureDetector(
                      ...
                      child:  Container(
                        child: Card(
                          child: Padding(
                      padding: const EdgeInsets.all(8),child: Column(mainAxisAlignment: MainAxisAlignment.center,
                      children: [
