...
class StaffHome extends ConsumerWidget{
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                title: Text(currentStaffStep == 1
                    ? 'Select City ' : currentStaffStep == 2 ? 'Select Salon'
                        : currentStaffStep == 3
                    ? 'Your Appoiment'
                        : 'Staff Home'),
                    ...
                    return GestureDetector(
                      ...
                      child: Card(
                        child: ListTile(
                          ...
                          shape: context.read(selectedSalon).state.name == salons[index].name ?
                          RoundedRectangleBorder(side: BorderSide(color: Colors.green ,width: 4),
                              borderRadius: BorderRadius.circular(5)) : null,
  ...
  displayAppoiment(BuildContext context) {
    //First , we need check is user a staff of this salon ???
    return FutureBuilder(
        ...
        builder:  (context,snapshot){
          if(snapshot.connectionState == ConnectionState.waiting)
            ...
            if (result)
              ...
              return Center(child: Text('Sorry ! You\'re not a staff of this salon'),);
          }
        });
  }
